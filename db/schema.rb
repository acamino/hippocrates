...
ActiveRecord::Schema.define(version: 20160608020453) do
  ...
  add_index "diseases", ["code"], name: "index_diseases_on_code", unique: true, using: :btree
  ...
  add_index "medicines", ["name"], name: "index_medicines_on_name", unique: true, using: :btree
